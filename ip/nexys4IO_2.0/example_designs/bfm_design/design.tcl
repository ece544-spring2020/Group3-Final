proc create_ipi_design { offsetfile design_name } {
	...
	set offset_file "${bd_path}/nexys4IO_v2_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef nexys4IO_v2_0_tb_include_vh_"
	puts $fp "`define nexys4IO_v2_0_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:nexys4IO:2.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/nexys4IO_v2_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "nexys4IO_v2_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 nexys4IO_v2_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top nexys4IO_v2_0_tb [get_filesets sim_1]
