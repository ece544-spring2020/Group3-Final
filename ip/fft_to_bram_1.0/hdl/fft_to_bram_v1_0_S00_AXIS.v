...
module fft_to_bram_v1_0_S00_AXIS #
(
...
(
	...
	output reg [BRAM_ADDR_WIDTH - 1:0] bram_write_addr,
...
reg [BRAM_ADDR_WIDTH - 1:0] next_bram_wr_addr;
...
always @(posedge S_AXIS_ACLK) begin
	...
	// following last, and the last word still needs to be clocked in to the BRAM.
